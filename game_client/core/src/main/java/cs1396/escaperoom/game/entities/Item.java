...
import cs1396.escaperoom.editor.tools.TiledBrush;
...
import cs1396.escaperoom.game.entities.conditions.ItemContainsItem;
import cs1396.escaperoom.game.entities.player.Player;
import cs1396.escaperoom.game.entities.player.PlayerAction;
import cs1396.escaperoom.game.entities.properties.AnimatedProperty;
import cs1396.escaperoom.game.entities.properties.connectors.ConnectorRelay;
import cs1396.escaperoom.game.entities.properties.connectors.ConnectorSource;
...
import cs1396.escaperoom.game.entities.properties.SpinnableProperty;
import cs1396.escaperoom.game.entities.properties.Stylable;
import cs1396.escaperoom.game.entities.properties.TiledBrushable;
import cs1396.escaperoom.game.entities.properties.base.ItemProperty;
import cs1396.escaperoom.game.entities.properties.util.PropertyMap;
...
public class Item implements Json.Serializable, Drawable {
  ...
  */
  ...
  /**
   * Construct an item from {@link ItemTypeData}
   *
   * @param typeData to construct from
   */
  public Item(ItemTypeData typeData) {
    initItem(typeData);
  }

  public void initItem(ItemTypeData typeData) {
  ...
  public void read(Json json, JsonValue jsonData) {
    ...
    this.objectTypeData = new ItemTypeData(item_name, typeCategory, new Size(width, height), texture, render_priority,
        null);
   ...
   *
   * - This includes an optional style prefix followed by the name spcecified by {@link ItemTypeData#name}
   */
  ...
  /**
   * Set whether this object is selected in the {@link LevelEditor}
   *
  ...
  /**
   * @return the {@link ItemTypeData} describing this item
   */
  public ItemTypeData getType() {
