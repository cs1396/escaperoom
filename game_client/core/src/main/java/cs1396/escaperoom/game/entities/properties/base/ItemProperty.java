package cs1396.escaperoom.game.entities.properties.base;
...
import cs1396.escaperoom.game.entities.properties.values.BooleanValue;
...
public abstract class ItemProperty<T extends ItemPropertyValue> implements Json.Serializable {
  ...
  /**
   * Called when this item is loaded onto into a {@link cs1396.escaperoom.screens.GameScreen}
   *
   * May be used to attach listeners to the {@link cs1396.escaperoom.game.state.GameEventBus}
   */
